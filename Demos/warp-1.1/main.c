...
main(int argc, char **argv)
{
     ...
     */
    screen = SDL_SetVideoMode(picture->w, picture->h, 8, (SDL_ANYFORMAT | SDL_DOUBLEBUF));
    if (screen == NULL)
    {
    ...
    {
        SDL_SetColors(screen, picture->format->palette->colors, 0, picture->format->palette->ncolors);
    }
